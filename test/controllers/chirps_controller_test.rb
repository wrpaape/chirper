...
class ChirpsControllerTest < ActionController::TestCase
  ...
  test "should create chirp" do
    assert_difference('Chirp.count') do
      post :create, chirp: { body: @chirp.body, title: @chirp.title, topic: @chirp.topic, user_id: @chirp.user_id }
    end
  ...
  test "should update chirp" do
    patch :update, id: @chirp, chirp: { body: @chirp.body, title: @chirp.title, topic: @chirp.topic, user_id: @chirp.user_id }
    assert_redirected_to chirp_path(assigns(:chirp))
  end
